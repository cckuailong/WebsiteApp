...
/**
 * internationId entity. @author MyEclipse Persistence Tools
 */

public class internationId  implements java.io.Serializable {
    ...
    /** default constructor */
    public internationId() {
    }

    
    /** full constructor */
    public internationId(String title, String date, String authorName, String thumbnailPicS, String url, String uniquekey, String type, String source) {
        this.title = title;
        this.date = date;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof internationId) ) return false;
		 internationId castOther = ( internationId ) other; 
