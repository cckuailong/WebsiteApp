...
/**
 * militaryId entity. @author MyEclipse Persistence Tools
 */

public class militaryId  implements java.io.Serializable {
    ...
    /** full constructor */
    public militaryId(String title, String date, String authorName, String thumbnailPicS, String url, String uniquekey, String type, String source) {
        this.title = title;
        this.date = date;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof militaryId) ) return false;
		 militaryId castOther = ( militaryId ) other; 
