...
/**
 * financeId entity. @author MyEclipse Persistence Tools
 */
...
public class financeId  implements java.io.Serializable {
    ...
    /** full constructor */
    public financeId(String title, String date, String authorName, String thumbnailPicS, String url, String uniquekey, String type, String source) {
        this.title = title;
        this.date = date;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof financeId) ) return false;
