...
/**
 * techId entity. @author MyEclipse Persistence Tools
 */

public class techId  implements java.io.Serializable {
    ...
    /** full constructor */
    public techId(String title, String date, String authorName, String thumbnailPicS, String url, String uniquekey, String type, String source) {
        this.title = title;
        this.date = date;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof techId) ) return false;
		 techId castOther = ( techId ) other; 
