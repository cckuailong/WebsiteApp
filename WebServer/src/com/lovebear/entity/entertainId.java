...
/**
 * entertainId entity. @author MyEclipse Persistence Tools
 */

public class entertainId  implements java.io.Serializable {
    ...
    /** full constructor */
    public entertainId(String title, String date, String authorName, String thumbnailPicS, String url, String uniquekey, String type, String source) {
        this.title = title;
        this.date = date;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof entertainId) ) return false;
		 entertainId castOther = ( entertainId ) other; 
