...
/**
 * sportId entity. @author MyEclipse Persistence Tools
 */

public class sportId  implements java.io.Serializable {
    ...
    /** full constructor */
    public sportId(String title, String date, String authorName, String thumbnailPicS, String url, String uniquekey, String type, String source) {
        this.title = title;
        this.date = date;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof sportId) ) return false;
		 sportId castOther = ( sportId ) other; 
