...
public class tencentInternation {

	private ArrayList<internation> tiList = new ArrayList<internation>();
	
	public ArrayList<internation> getTiList() {
		return tiList;
	}

	public void setTiList(ArrayList<internation> tiList) {
		this.tiList = tiList;
	}
